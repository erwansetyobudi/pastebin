...
// Procurement Report With Chaching Methode
// By Erwan Setyo Budi
// key to authenticate
define('INDEX_AUTH', '1');
...
<?php
    ...
    $cache_file = $cache_dir . 'procurement_report_cache.html';
    $cache_lifetime = 86400; // 1 hari
    ...
    // simpan hasil ke file cache
    file_put_contents($cache_file, $content);

    // tampilkan dalam template SLiMS
